...
- Paper discussed calculating the probability that one player, A, wins a tennis match against another player, B

- Based on other papers involving calculating the probability of winning a game in other racket sports the conclusion was made to treat points in tennis as  independent identically distributed (iid) random variables

- Although it is noted at points in tennis are not iid for most purposes this is not a bad assumption as the divergence from iid is small
  
  - This was supported by a statistical anaylsis of 4 years of Wimbledon data

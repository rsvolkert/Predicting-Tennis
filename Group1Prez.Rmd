...
#T2<- table(base::sample(rownames(Tourney1_Women), 2000, prob = Tourney1_Women$Our.P.Winning.the.Tournement., replace = TRUE)) 
...
#T2<- table(base::sample(rownames(Tourney1_Men), 2000, prob = Tourney1_Men$Our.P.Winning.the.Tournement., replace = TRUE)) 
#Winner2 <- which(T2 == max(T2))
#Winner2

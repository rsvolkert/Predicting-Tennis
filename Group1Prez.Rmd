...
mWim02$pTC <- as.numeric(pTC(pRally[1], pRally[2], pRally[3], pRally[4], 2))
...
mWim19$pTC <- as.numeric(pTC(pRally[1], pRally[2], pRally[3], pRally[4], 2))
